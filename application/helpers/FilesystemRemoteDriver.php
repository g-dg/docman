...
class FilesystemRemoteDirectoryHandle implements IFilesystemDirectoryHandle
{
	private $driver;
	private $CI;
...
class FilesystemRemoteFileHandle implements IFilesystemFileHandle
{
	private $driver;
	private $CI;
	public function __construct($driver)
...
class FilesystemRemoteDriver implements IFilesystemDriver
{
	private $CI;
